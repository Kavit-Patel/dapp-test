...
declare_id!("G7BkPkX43UiUW8gKNouosvNV5j4UqWPL59Pmr3DdngqR");
#[program]
pub mod vesting {
    use super::*;
    ...
    pub fn claim_tokens(ctx: Context<ClaimTokens>, _company_name: String) -> Result<()> {
        ...
        // Check if the cliff time has passed
        ...
        // Ensure claimable_amount is non-negative and scale it
        ...
        // CPI: Transfer tokens from treasury to employee's token account
